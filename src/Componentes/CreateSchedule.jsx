...
//       end_Time: endTime,
//       available: available,
//       interval: parseInt(interval), // Asegúrate de convertir interval a número
//     };
...
//         setStartTime("");
//         setEndTime("");
//         setInterval("30"); // Asegúrate de corregir esto a setInterval("30")
//         setAvailable(true);
//         setError("");
//       } else {
//         const errorData = await response.json();
//         setError(errorData.message || "Error creando la agenda.");
//         console.error("Error creando turnos", response.statusText);
//       }
//     } catch (error) {
//       console.error("Error creando turnos", error);
...
//   const handleIntervalChange = (event) => {
//     setInterval(event.target.value); // Asegúrate de manejar correctamente el cambio de intervalo
//   };
